...
public class RootBeer {
    ...
    public boolean isEmulator(){
        if (!canLoadNativeLibrary()){
            QLog.e("We could not load the native library to test for Emulator");
            return false;
        }
        return new RootBeerNative().isDetected();
    }

    public String systemResult(){
        return new RootBeerNative().getResult();
    }
